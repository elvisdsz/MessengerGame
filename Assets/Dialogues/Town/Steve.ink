...
=thank_for_saving
{STEVE_THANKED>-1: ->END} {PLAYER_BETRAYED==0 && COMPANION_BETRAYED==0: ...| ->END}
{PLAYER_BETRAYED==-1 && COMPANION_BETRAYED==-1: ->END}
I overheard the guard ask you about me. Thank you for standing up for me.
